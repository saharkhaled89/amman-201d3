...
function sum(a,b) { //eslint-disable-line
    ...
    var sumVal= a+b; 
    return [sumVal , 'The sum of 4 and 7 is 11.'];
...
function multiply(a, b) { //eslint-disable-line
  ...
  var cMulti= a * b;
    return [cMulti,'The product of 5 and 9 is 45.' ];
...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns an array
 where the first element is the sum of those three numbers, the second element is the product of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
